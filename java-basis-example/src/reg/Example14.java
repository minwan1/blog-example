...
public class Example14 {
    ...
    public static void main(String args[]) {
        final String case1 = "--XX-@-XX-@@-XX-@@@-XX-@@@@-XX-@@-@@-";
        final Pattern pattern1 = Pattern.compile("-X?XX?X");
        ...
        while (result1) {
            if (result1) { // true
                ...
                System.out.println(matcher1.group()); //-XX,-XX,-XX,-XX,-XX
            }
            result1 = matcher1.find();
        }

        final String case2 = "--XX-@-XX-@@-XX-@@@-XX-@@@@-XX-@@-@@-";
        ...
        final String case3 = "--XX-@-XX-@@-XX-@@@-XX-@@@@-XX-@@-@@-";
